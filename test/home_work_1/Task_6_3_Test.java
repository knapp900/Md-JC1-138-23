...
public class Task_6_3_Test {
    ...
    public void greetingsTest_1() {
        ...
        Assertions.assertEquals(Task_6_3.greetings("Вася"), "Привет!\nЯ тебя так долго ждал");
    ...
    public void greetingsTest_2() {
        ...
        Assertions.assertEquals(Task_6_3.greetings("Анастасия"), "Я тебя так долго ждал");
    ...
    public void greetingsTest_3() {
        ...
        Assertions.assertEquals(Task_6_3.greetings("другое имя"), "Добрый день, а вы кто?");
